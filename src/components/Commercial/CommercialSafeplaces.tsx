...
const CommercialSafeplaces: React.FC<{
  ...
  const placeholderTitle = "Titre de votre publicité";
  const placeholderDescription = "Description de votre publicité";

  const updateCampaignModal = (campaign: ICampaign, modalType: ModalType) => {
    setModal(modalType);
                      ...
                      <div className='flex flex-row p-8'>
                        ...
                        <div className="flex flex-auto flex-col pl-6">
                          ...
                          <FaEdit className='mt-2' onClick={() => {
                            updateCampaignModal(item, ModalType.UPDATE)
                          }} />
                          <div className='flex justify-end mb-1'>
                            <div className='shadow-[0_05px_09px_rgba(0,0,0,0.25)]'>
                              <button
