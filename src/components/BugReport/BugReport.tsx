                ...
                <div className="mx-4 card bg-white max-w-md p-10 md:rounded-lg my-8 mx-auto">
                    ...
                    <div className="form mt-4">
                        <div className="flex flex-col text-sm">
                            ...
                            <input className=" appearance-none border border-gray-200 p-2 focus:outline-none focus:border-gray-500" type="text" placeholder="Entrer un titre" />
                        </div>

                        <div className="text-sm flex flex-col">
                            <label className="font-bold mt-4 mb-2">Description</label>
                            <textarea className=" appearance-none w-full border border-gray-200 p-2 h-40 focus:outline-none focus:border-gray-500" id={report}  placeholder="Entrer une description"></textarea>
                        </div>
                    </div>
